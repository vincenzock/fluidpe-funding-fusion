...
import { 
  ...
  TrendingDown, AlertTriangle, LightbulbIcon, Zap, Lock, FileCheck, Settings, Users, RefreshCw
} from 'lucide-react';
    ...
    <div className="overflow-x-hidden font-sans">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedElement animation="fade-up">
            <div className="flex flex-col items-center justify-center mb-16">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-fluidpe-teal to-fluidpe-medium-teal rounded-full mb-6"></div>
              <p className="text-lg md:text-xl text-gray-600 mb-6 max-w-3xl mx-auto text-center">
                See how Fluidpe has helped customers achieve their financial goals without compromising their investments
              </p>
            </div>
          </AnimatedElement>
      ...
      <section id="faq" className="py-16 md:py-24 bg-white relative overflow-hidden">
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute left-[-5%] bottom-[10%] w-80 h-80 rounded-full bg-fluidpe-light-gold/20 blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedElement animation="fade-up">
            <div className="flex flex-col items-center justify-center mb-16">
              <div className="bg-gradient-to-r from-fluidpe-teal/20 to-fluidpe-medium-teal/20 p-2 px-4 rounded-full mb-4">
                <span className="text-fluidpe-teal text-sm font-semibold">Your Questions Answered</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center bg-gradient-to-r from-fluidpe-teal to-fluidpe-medium-teal bg-clip-text text-transparent">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-fluidpe-teal to-fluidpe-medium-teal rounded-full mb-6"></div>
              <p className="text-lg md:text-xl text-gray-600 mb-6 max-w-3xl mx-auto text-center">
                Find answers to commonly asked questions about loans against mutual funds
              </p>
            </div>
          </AnimatedElement>
      ...
      <section id="cta" className="py-16 md:py-20 bg-gradient-to-r from-fluidpe-teal to-fluidpe-medium-teal relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute left-[10%] bottom-[10%] w-80 h-80 rounded-full bg-white blur-xl"></div>
          <div className="absolute right-[30%] bottom-[30%] w-64 h-64 rounded-full bg-white blur-xl"></div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedElement delay={200} animation="fade-up">
              <p className="text-lg md:text-xl text-white/90 mb-8 text-center">
                Get started with Fluidpe today and access the liquidity you need while keeping your investments intact
              </p>
            </AnimatedElement>
            
            <AnimatedElement delay={400} animation="fade-up">
              <div className="flex flex-col md:flex-row gap-4 justify-center">
                <Button className="bg-white text-fluidpe-teal hover:bg-white/90 px-8 py-6 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1" size="lg">
                  Apply Now
                </Button>
                <Button className="bg-transparent border border-white text-white hover:bg-white/10 px-8 py-6 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1" size="lg">
                  Learn More
                </Button>
              </div>
            </AnimatedElement>
